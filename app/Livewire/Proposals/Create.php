...
use App\Notifications\ProposalThatLostPosition;
...
class Create extends Component
{
    ...
    public function arrangePositions(Proposal $proposal)
    {
        ...
        if ($otherProposal) {
            ...
            $proposalThatLostPosition = Proposal::find($otherProposal->id);
            $proposalThatLostPosition->update(['position_status' => 'down']);
            $proposalThatLostPosition->notify(new ProposalThatLostPosition($this->project));
        }
