        ...
        >
            ...
            <div class="flex gap-4">
                <div class="w-2/3 gap-2 flex flex-col">
                    ...
                    />
                    @error('email')
                        <span class="text-red-400 mt-1 text-xs">{{ $message }}</span>
                    @enderror
                </div>
                <div class="w-1/3 gap-2 flex flex-col">
                    ...
                    <div
                        class="flex"
                        x-data="{ hours: @entangle('hours') }"
                    >
                        <button
                            @click="hours--"
                            class="bg-[#1E1E2C] hover:bg-[#313145] transition duration-300 ease-in-out text-[#C3C3D1] text-3xl flex items-center justify-center leading-none"
                            type="button"
                        >
                            <span class="w-9 h-9">-</span>
                        </button>
                        <input
                            class="bg-[#1E1E2C] text-white py-2 w-full font-bold focus:outline-none focus:ring-0 border border-[#1E1E2C] focus:ring-blue-500 text-center"
                            type="number"
                            wire:model="hours"
                        />
                        <button
